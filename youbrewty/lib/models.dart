// Barrel export to preserve existing import paths.
// Some files import `package:youbrewty/models.dart` or `../models.dart`.
// The real implementation lives in `lib/models/models.dart`.
